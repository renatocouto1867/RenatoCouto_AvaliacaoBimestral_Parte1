package com.example.renatocouto_avaliacaobimestral_parte1.util;
...
public abstract class PermissionUtils {
    ...
    public static void requestLocationPermissions(AppCompatActivity activity,
        ...
        if (ActivityCompat
                .shouldShowRequestPermissionRationale(activity, permission.CAMERA)) {
            // você pode verificar se o aplicativo deve exibir uma explicação. Se o método retornar true,
            // isso significa que o usuário já recusou a permissão pelo menos uma vez,
            // e você deve fornecer uma justificativa antes de solicitar novamente.
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        @Override
        public void onDismiss(DialogInterface dialog) {
            //O método onDismiss é chamado independentemente de como o diálogo foi fechado
            super.onDismiss(dialog);
            if (finishActivity) {
